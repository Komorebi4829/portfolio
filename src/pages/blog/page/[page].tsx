...
const BlogPage: NextPage<ContentPageProps> = ({ posts, initialDisplayPosts, pagination }) => {
  return (
    <>
      <NextSeo title={`${PAGE_TITLE} - ${siteMetadata.author}`} />
      <Container className='xl:!-mt-5' data-aos='fade-up'>
        <BlogListNew posts={posts} initialDisplayPosts={initialDisplayPosts} pagination={pagination} />
      </Container>
    </>
  )
}
