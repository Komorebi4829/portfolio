...
5.  Returning the result: The function returns the calculated sum as the final result. Let's implement the solution:
...
Example: Let's illustrate the process with an example:
