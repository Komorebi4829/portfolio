...
export const STACKS: stacksProps = {
  ...
  MongoDB: <SiMongodb size={iconSize} className='text-purple-600' />,
  Git: <SiGit size={iconSize} className='text-orange-500' />,
  Redis: <SiRedis size={iconSize} className='text-red-600' />,
  PostgreSQL: <SiPostgresql size={iconSize} className='text-purple-600' />,
  Docusaurus: <SiDocusaurus size={iconSize} className='text-purple-600' />,
  Flask: <SiFlask size={iconSize} />,
  Django: <SiDjango size={iconSize} />,
  'Vue.js': <SiVuedotjs size={iconSize} className='text-green-400' />,
  FastAPI: <SiFastapi size={iconSize} className='text-green-600' />,
  VSCode: <SiVisualstudiocode size={iconSize} className='text-blue-500' />,
  Drone: <SiDrone size={iconSize} />,
  Docker: <SiDocker size={iconSize} className='text-blue-600' />,
  ...
  Vite: <SiVite size={iconSize} className='text-fuchsia-400' />,
  ...
  MQTT: <SiMqtt size={iconSize} className='text-fuchsia-400' />,
}
