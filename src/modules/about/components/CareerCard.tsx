...
const CareerCard = ({ position, company, logo, location, start_date, end_date, link }: CareerProps) => {
  ...
  return (
    <Card className='flex items-center gap-5 py-4 px-6 border border-neutral-300 dark:border-neutral-900'>
      {logo ? <Image src={logo} width={55} height={55} alt={company} /> : <CompanyIcon size={50} />}
