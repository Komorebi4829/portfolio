...
const Chat = ({ isWidget = false }: { isWidget?: boolean }) => {
  ...
  return (
    <>
      <ChatList isWidget={isWidget} messages={messages} onDeleteMessage={handleDeleteMessage} />
      {session ? <ChatInput onSendMessage={handleSendMessage} isWidget={isWidget} /> : <ChatAuth />}
    </>
  )
}
